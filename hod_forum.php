...
<head>
    <meta charset="UTF-8">
    <title>HOD Discussion Forum | University Smart Portal</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-3">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto me-3 d-none d-lg-flex">
                <a class="nav-link<?php if(basename($_SERVER['PHP_SELF'])=='hod_dashboard.php') echo ' active'; ?>" href="hod_dashboard.php">
                    <i class="bi bi-house-door me-1"></i>Dashboard
                </a>
                <a class="nav-link<?php if(basename($_SERVER['PHP_SELF'])=='hod_leave_approval.php') echo ' active'; ?>" href="hod_leave_approval.php">
                ...
                <a class="nav-link<?php if(basename($_SERVER['PHP_SELF'])=='hod_forum.php') echo ' active'; ?>" href="hod_forum.php">
