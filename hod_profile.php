...
// Check if hod_profiles table exists, create if not
$check_table = $conn->query("SHOW TABLES LIKE 'hod_profiles'");
if ($check_table->num_rows == 0) {
    ...
    if (!$conn->query($create_table_sql)) {
        die("Error creating hod_profiles table: " . $conn->error);
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insert or update hod profile using ON DUPLICATE KEY UPDATE
    $update_profile = $conn->prepare("INSERT INTO hod_profiles (user_id, employee_id, designation, phone, email, qualification, experience, specialization, address) 
                                     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) 
...
$stmt = $conn->prepare("SELECT u.name, u.email, u.department, 
                              hp.employee_id, hp.designation, hp.phone, hp.qualification, 
                              hp.experience, hp.specialization, hp.address 
                       FROM users u 
                       LEFT JOIN hod_profiles hp ON u.id = hp.user_id 
                       WHERE u.id = ?");
...
<head>
    ...
    <title>HOD Profile | University Smart Portal</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
    <style>
        /* Same styles as faculty_profile.php */
        body {
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-3">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto me-3 d-none d-lg-flex">
                ...
                <a class="nav-link active" href="hod_profile.php">
        ...
        <div class="profile-card main-container">
            ...
            <div class="profile-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <div>
                            <h2 class="mb-2 fw-bold text-start">HOD Profile</h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="position-relative dropdown">
                                ...
                                <ul class="dropdown-menu w-100">
                                    <li><a class="dropdown-item" href="#" onclick="event.preventDefault();selectDesignation('HOD')">HOD</a></li>
