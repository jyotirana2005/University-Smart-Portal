...
// Only for new post, new reply, and delete
...
<head>
    <meta charset="UTF-8">
    <title>Student Discussion Forum | University Smart Portal</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-3">
        <div class="container">
            ...
            <div class="navbar-nav d-none d-lg-flex flex-fill justify-content-center">
                ...
                <a class="nav-link active" href="student_forum.php">
                    <i class="bi bi-chat-dots me-1"></i>Forum
                </a>
...
// AJAX Add Reply (for each reply form)
